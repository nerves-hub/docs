...
| `NERVES_HUB_FW_PRIVATE_KEY`  | `NERVES_CLOUD_FW_PRIVATE_KEY`    | Firmware signing private key (Ed25519)   |
| `NERVES_HUB_FW_PUBLIC_KEY`   | `NERVES_CLOUD_FW_PUBLIC_KEY`     | Firmware signing public key (Ed25519)    |
