...
Console I/O is then exchanged as events on this topic. See the [WebSocket Events reference](/device-api/websocket-events) for the full list of events on each topic.
