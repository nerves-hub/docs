...
<CardGroup cols={2}>
  ...
  <Card title="How-to Guides" icon="wrench" href="/setup/products">
  ...
  <Card title="Concepts" icon="lightbulb" href="/architecture">
    Architecture, authentication, deltas, and the ideas behind the platform.
  </Card>

  <Card title="Production Setup" icon="shield-check" href="/auth/nerveskey">
