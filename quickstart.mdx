...
<Note>
  Shared secrets suit hobby and R&D projects. For production, use certificate auth. See [Device authentication & mTLS](/concepts/device-authentication-mtls).
</Note>
...
<Steps>
  ...
  <Step title="Point your project at the signing key">
    ...
    <Info>
      Paths and variable names vary by CLI version and platform. See the [CLI reference](/reference/cli-nh). The `NERVES_HUB_*` equivalents also work.
    </Info>
  </Step>
  ...
  <Step title="Create a deployment group">
    ...
    Full options: [Deployment groups & releases](/guides/deployment-groups-releases).
  </Step>
...
- [Device authentication & mTLS](/concepts/device-authentication-mtls)
- [Deployment groups & releases](/guides/deployment-groups-releases)
- [Firmware deltas](/concepts/firmware-deltas)
- [Remote console & local shell](/guides/remote-console)
